          ...
          <div key={index} className="col d-flex align-items-stretch">
            <StyledCard theme={theme} onClick={() => handleExpand(index)}>
              <CardBody>
                ...
                <EventDate><i className="far fa-calendar-alt me-2"></i>{event.date}</EventDate>
                <EventLocation><i className="fas fa-map-marker-alt me-2"></i>{event.location}</EventLocation>
                {expandedEvent === index && (
                  <Details theme={theme}>
                    <p>{event.details}</p>
                  </Details>
